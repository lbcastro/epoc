...
public class ChannelsValues {
    ...
    public final static int[] F7_BITS = {
            48, 49, 50, 51, 52, 53, 54, 55, 40,
            41, 42, 43, 44, 45
    };
    public final static int[] T7_BITS = {
            66, 67, 68, 69, 70, 71, 56, 57, 58,
            59, 60, 61, 62, 63
    };
    public final static int[] P7_BITS = {
            84, 85, 86, 87, 72, 73, 74, 75, 76,
            77, 78, 79, 64, 65
    };
    public final static int[] O1_BITS = {
            102, 103, 88, 89, 90, 91, 92, 93, 94,
            95, 80, 81, 82, 83
    };
    public final static int[] O2_BITS = {
            140, 141, 142, 143, 128, 129, 130, 131, 132,
            133, 134, 135, 120, 121
    };
    public final static int[] P8_BITS = {
            158, 159, 144, 145, 146, 147, 148, 149, 150,
            151, 136, 137, 138, 139
    };
    public final static int[] T8_BITS = {
            160, 161, 162, 163, 164, 165, 166, 167, 152,
            153, 154, 155, 156, 157
    };
    public final static int[] F8_BITS = {
            178, 179, 180, 181, 182, 183, 168, 169, 170,
            171, 172, 173, 174, 175
    };
    public final static int[] AF4_BITS = {
            196, 197, 198, 199, 184, 185, 186, 187, 188,
            189, 190, 191, 176, 177
    };
    public final static int[] FC6_BITS = {
            214, 215, 200, 201, 202, 203, 204, 205, 206,
            207, 192, 193, 194, 195
    };
    public final static int[] F4_BITS = {
            216, 217, 218, 219, 220, 221, 222, 223, 208,
            209, 210, 211, 212, 213
    };
