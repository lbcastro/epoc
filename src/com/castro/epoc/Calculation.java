...
public class Calculation extends Fragment implements PropertyChangeListener {
    ...
    public void checkSide(int side) {
        if (!mCalculationActive || !mCalculationInitiated)
            return;
        mResultText.setTextColor(side == mCorrectSide ? mCorrectColor : mWrongColor);
     ...
     * @param correct Specifies if the operation should be correct or false
    ...
    private void initiateTextViews() {
        mResultText = (TextView)mFragmentView.findViewById(R.id.calculation_result);
        mLevelText = (TextView)mFragmentView.findViewById(R.id.calculation_level);
        mFirstAnswerText = (TextView)mFragmentView.findViewById(R.id.calculation_first);
        mSecondAnswerText = (TextView)mFragmentView.findViewById(R.id.calculation_second);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mFragmentView = inflater.inflate(R.layout.activity_calculation, container, false);
        initiateTextViews();
